#ifndef _ROS_SERVICE_node_set_joint_position_h
#define _ROS_SERVICE_node_set_joint_position_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_SET_JOINT_POSITION[] = "webots_ros/node_set_joint_position";

  class node_set_joint_positionRequest : public ros::Msg
  {
    public:
    ...
    node_set_joint_positionRequest():
      node(0),
      position(0),
      index(0)
    {
    ...
    virtual const char * getType() override { return NODE_SET_JOINT_POSITION; };
    virtual const char * getMD5() override { return "cae15c1d507db8a044c5153d82370ba9"; };

  };

  class node_set_joint_positionResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    node_set_joint_positionResponse():
      success(0)
    {
    }
